# Generated by Django 4.0 on 2022-02-18 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=200)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='trainer_task_trainee', to='app.user_registration')),
            ],
        ),
        migrations.CreateModel(
            name='topic',
